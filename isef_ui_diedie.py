...
if os.path.exists(model_path):
    print("✅ Model file found in Render!")

    # ✅ Compute SHA256 hash in Render
    with open(model_path, "rb") as f:
        render_model_hash = hashlib.sha256(f.read()).hexdigest()

    print(f"🔍 SHA256 Hash (IN RENDER): {render_model_hash}")

else:
    raise FileNotFoundError(f"❌ Model file NOT found at: {model_path}")


print("✅ polyreactivity_modelthree.joblib found in Render!")

# ✅ Check file size to confirm correct upload
file_size = os.path.getsize(model_path)
print(f"📂 Model file size: {file_size} bytes")
print("✅ Model loaded successfully with mmap_mode='r'!")

# ✅ Attempt to load the file
try:
    model = joblib.load("final_model_fixed_uncompressed.joblib", mmap_mode="r")
...
# ✅ GitHub RAW URL for your file (REPLACE WITH YOUR ACTUAL GITHUB URL)
github_url = "https://raw.githubusercontent.com/sankas27/isef_project/main/final_model_fixed_uncompressed.joblib"
model_path = "final_model_fixed_uncompressed.joblib"
...
# ✅ Verify the file exists after downloading
if os.path.exists(model_path):
    print("✅ Model successfully downloaded in Render!")
else:
