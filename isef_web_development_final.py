...
# ✅ Step 3: Load the model with the correct function scope
try:
    model = load(model_path, mmap_mode="r")
    print("✅ Model loaded successfully!")
except AttributeError:
    import joblib
    model = joblib.load(model_path, mmap_mode="r", fix_imports=True)
    print("✅ Model reloaded with `joblib.load`.")

# ✅ Step 4: Load the vectorizer with explicit reference to `kmer_tokenizer`
try:
