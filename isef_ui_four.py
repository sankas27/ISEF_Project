...
# ✅ Step 3: Load the model and explicitly allow `kmer_tokenizer`
try:
    model = load(model_path)
    print("✅ Model loaded successfully!")
except AttributeError:
    import joblib
    model = joblib.load(model_path, custom_imports={"kmer_tokenizer": kmer_tokenizer})  # ✅ Explicitly pass function
    print("✅ Model reloaded with `joblib.load()`.")

# ✅ Step 4: Load the vectorizer and explicitly allow `kmer_tokenizer`
try:
    vectorizer = load(vectorizer_path)
    print("✅ Vectorizer loaded successfully!")
except AttributeError:
    import joblib
    vectorizer = joblib.load(vectorizer_path, custom_imports={"kmer_tokenizer": kmer_tokenizer})  # ✅ Explicitly pass function
    print("✅ Vectorizer reloaded with `joblib.load()`.")
