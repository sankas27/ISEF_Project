...
# ✅ Step 1: Define kmer_tokenizer Function (Must Match Training)
...
# ✅ Step 3: Load Vectorizer with Custom Function Registration
try:
    vectorizer = joblib.load(vectorizer_path)  # ✅ Attempt normal load
    print("✅ Vectorizer loaded successfully!")
except Exception as e:
    print(f"❌ Vectorizer loading failed: {e}")
 # ✅ Second Attempt: Manually Define Vectorizer
    try:
        with open(vectorizer_path, "rb") as f:
            vectorizer = joblib.load(f)  # ✅ Proper way to load without fix_imports
        print("✅ Vectorizer loaded on second attempt!")
    except Exception as e:
        raise RuntimeError(f"❌ Vectorizer could not be loaded by any method: {e}")

# ✅ Step 4: Load Feature Selector
try:
...
# ✅ Step 5: Load Machine Learning Model
try:
...
# ✅ Step 6: Function to Transform Sequences
def extract_kmer_features(sequence):
    try:
        X_kmer = vectorizer.transform([sequence])  # ✅ Ensure this runs correctly
        X_selected = selector.transform(X_kmer)   # ✅ Check feature count
        return X_selected
    except Exception as e:
...
# ✅ Step 10: Use the Correct Port for Render
