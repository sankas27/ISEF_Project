...
# ✅ Step 2: Register kmer_tokenizer before loading model
import sys
import types
...
# ✅ Step 4: Load the model and explicitly allow `kmer_tokenizer`
try:
    model = joblib.load(model_path)  # ✅ Now Python can find kmer_tokenizer
    print("✅ Model loaded successfully!")
except AttributeError:
    raise RuntimeError("❌ Model loading failed. Make sure the function `kmer_tokenizer` is registered.")

# ✅ Step 5: Load the vectorizer and explicitly allow `kmer_tokenizer`
try:
    vectorizer = joblib.load(vectorizer_path)  # ✅ Now Python can find kmer_tokenizer
    print("✅ Vectorizer loaded successfully!")
except AttributeError:
    raise RuntimeError("❌ Vectorizer loading failed. Make sure the function `kmer_tokenizer` is registered.")

# ✅ Step 6: Load the feature selector
if os.path.exists(selector_path):
    selector = joblib.load(selector_path)  # ✅ No function dependency needed
