...
# ✅ Step 2: Custom Unpickler to Fix "Can't Get Attribute 'kmer_tokenizer'"
class CustomUnpickler(joblib.numpy_pickle.NumpyUnpickler):
    def find_class(self, module, name):
        if name == "kmer_tokenizer":
            return kmer_tokenizer  # ✅ Register kmer_tokenizer
