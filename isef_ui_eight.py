...
# ✅ Step 2: Manually Register kmer_tokenizer in a Dummy Module
module_name = "custom_functions"
custom_module = types.ModuleType(module_name)
sys.modules[module_name] = custom_module
setattr(custom_module, "kmer_tokenizer", kmer_tokenizer)  # ✅ Register function in Python's import system
...
# ✅ Step 4: Load the vectorizer first (because the model depends on it)
try:
