...
# ✅ Step 2: Load trained model, vectorizer, and feature selector (LOCAL FILE PATHS)
model_path = "./polyreactivity_modeltwo.pkl"  # ✅ Use .pkl file instead of .joblib
vectorizer_path = "./vectorizer.pkl"
selector_path = "./feature_selector.pkl"

# ✅ Step 3: Load the model using `pickle.load()` and explicitly allow `kmer_tokenizer`
try:
    with open(model_path, "rb") as f:
        model = pickle.load(f)  # ✅ Use pickle instead of joblib
    print("✅ Model loaded successfully!")
except AttributeError:
    with open(model_path, "rb") as f:
        model = pickle.load(f)  # ✅ Retry with pickle
    print("✅ Model reloaded using pickle.")

# ✅ Step 4: Load the vectorizer using `pickle.load()`
try:
    with open(vectorizer_path, "rb") as f:
        vectorizer = pickle.load(f)  # ✅ Use pickle instead of joblib
    print("✅ Vectorizer loaded successfully!")
except AttributeError:
    with open(vectorizer_path, "rb") as f:
        vectorizer = pickle.load(f)  # ✅ Retry with pickle
    print("✅ Vectorizer reloaded using pickle.")

# ✅ Step 5: Load the feature selector
if os.path.exists(selector_path):
    with open(selector_path, "rb") as f:
        selector = pickle.load(f)  # ✅ Use pickle instead of joblib
